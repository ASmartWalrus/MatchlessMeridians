...
/**
 * @param {string[]} meridian_strs
 * @returns {any}
 */
export function init_solver(meridian_strs) {
    const ptr0 = passArrayJsValueToWasm0(meridian_strs, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.init_solver(ptr0, len0);
    return ret;
}
 ...
 * @returns {any}
 */
export function step_solver(solver_js) {
    const ret = wasm.step_solver(solver_js);
    return ret;
}

const KungFuFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_kungfu_free(ptr >>> 0, 1));
...
export class KungFu {
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        KungFuFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_kungfu_free(ptr, 0);
    }
    /**
     * @returns {bigint}
     */
    get acupoint_bits() {
        const ret = wasm.__wbg_get_kungfu_acupoint_bits(this.__wbg_ptr);
        return BigInt.asUintN(64, ret);
    }
    /**
     * @param {bigint} arg0
     */
    set acupoint_bits(arg0) {
        wasm.__wbg_set_kungfu_acupoint_bits(this.__wbg_ptr, arg0);
    }
    /**
     * @returns {number}
     */
    get length() {
        const ret = wasm.__wbg_get_kungfu_length(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @param {number} arg0
     */
    set length(arg0) {
        wasm.__wbg_set_kungfu_length(this.__wbg_ptr, arg0);
    }
}
